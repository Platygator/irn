...
if __name__ == '__main__':
    ...
    parser.add_argument("--bset_root", required=True, type=str,
                        help="Path to boulderSet")

    # Dataset
    # TODO check what train_aug really is
    parser.add_argument("--train_list", default="/home/jan/Datasets/boulderSet/splits/train.txt", type=str)
    parser.add_argument("--val_list", default="/home/jan/Datasets/boulderSet/splits/val.txt", type=str)
    parser.add_argument("--infer_list", default="/home/jan/Datasets/boulderSet/splits/train.txt", type=str,
